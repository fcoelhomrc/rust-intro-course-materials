...
// (adicionar e remover items, mover items de um local para outro).
// Deve ter tipos de erros explícitos e informativos.

// TODO: Make sure all get_* functions return Options [✅ Done]
// TODO: Make sure adding, removing, moving, etc. items return Results [✅ Done]
